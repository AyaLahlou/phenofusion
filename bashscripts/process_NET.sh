...
#SBATCH --job-name=process_NET    # The job name
#SBATCH --output=process_NET.out    # The output file name
...
PFT="NET"
DATA_DIR="/burg-archive/glab/users/al4385/data/NET_merged/sorted_NET_merged_1982_2021.parquet"
