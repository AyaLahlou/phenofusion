...
#SBATCH --job-name=pred_bdt_50_90   # The job name
#SBATCH --output=pred_bdt_50_90.out    # The output file name
...
DATE=$(date '+%Y%m%d')
DATA_DIR="/burg/glab/users/al4385/data/TFT_30_40_BDTinterval/sorted_BDT_50_90_1982_2021.pkl"
WEIGHTS_DIR="/burg/glab/users/al4385/weights/pretrained_1219/weights_merged_BDT_1982_2021_feb2025_checkpoint.pth"
PRED_DIR="/burg/glab/users/al4385/predictions/pretrained_0331/sorted_BDT_50_90_1982_2021.pkl"

#july 2025
DATA_DIR="/burg/glab/users/al4385/data/TFT_40_overlapping_samples/sorted_BDT_50_90_1982_2021.pkl"
WEIGHTS_DIR="/burg/glab/users/al4385/weights/pretrained_1219/weights_merged_BDT_1982_2021_feb2025_checkpoint.pth"
PRED_DIR="/burg/glab/users/al4385/predictions/pred_40year_moresamples/BDT/BDT_50_90_1982_2021.pkl"
