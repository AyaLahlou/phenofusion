...
#SBATCH --job-name=pred_NET   # The job name
#SBATCH --output=pred_NET.out    # The output file name
...
#july 2025
DATA_DIR="/burg/glab/users/al4385/data/TFT_40_overlapping_samples/sorted_NET_merged_1982_2021.pkl"
WEIGHTS_DIR=/burg/glab/users/al4385/weights/pretrained_1219/weights_NET_2.pth
PRED_DIR="/burg/glab/users/al4385/predictions/pred_40year_moresamples/NET/NET_1982_2021.pkl"
