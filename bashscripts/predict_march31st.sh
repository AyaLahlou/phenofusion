...
DATE=$(date '+%Y%m%d')
DATA_DIR="/burg/glab/users/al4385/data/TFT_30_40_BDTinterval/sorted_BDT_-20_-60_1982_2021.pkl"
WEIGHTS_DIR="/burg/glab/users/al4385/weights/pretrained_1219/weights_merged_BDT_1982_2021_feb2025_checkpoint.pth"
PRED_DIR="/burg/glab/users/al4385/predictions/pretrained_0331/pred_BDT_-20_-60_1982_2021.pkl"
