...
#SBATCH --job-name=pred_BET   # The job name
#SBATCH --output=pred_BET.out    # The output file name
...
#july 2025
DATA_DIR="/burg/glab/users/al4385/data/TFT_40_overlapping_samples/sorted_BET_merged_1982_2021.pkl"
WEIGHTS_DIR=/burg/glab/users/al4385/weights/pretrained_1219/weights_BET.pth
PRED_DIR="/burg/glab/users/al4385/predictions/pred_40year_moresamples/BET/BET_1982_2021.pkl"
