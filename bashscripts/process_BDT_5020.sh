...
#SBATCH --job-name=process_5020    # The job name
#SBATCH --output=process_5020.out    # The output file name
...
PFT="BDT_50_20"
DATA_DIR="/burg-archive/glab/users/al4385/data/CSIFMETEO/sorted_BDT_50_20_merged_1982_2021.parquet"
