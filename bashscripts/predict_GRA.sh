...
#SBATCH --job-name=pred_GRA   # The job name
#SBATCH --output=pred_GRA.out    # The output file name
...
#oct 2025 DEV
DATA_DIR="/burg/glab/users/$USER/data/TFT_30/sorted_GRA.pkl"
WEIGHTS_DIR=/burg/glab/users/$USER/weights/pretrained_1219/weights_sorted_GRA_dev.pth
PRED_DIR="/burg/glab/users/$USER/predictions/pred_TFT_30_dev/GRA/GRA_1982_2021.pkl"
