...
#SBATCH --job-name=pred_NDT   # The job name
#SBATCH --output=pred_NDT.out    # The output file name
...
#july 2025
DATA_DIR="/burg/glab/users/al4385/data/TFT_40_overlapping_samples/sorted_NDT_merged_1982_2021.pkl"
WEIGHTS_DIR=/burg/glab/users/al4385/weights/pretrained_1219/weights_NDT.pth
PRED_DIR="/burg/glab/users/al4385/predictions/pred_40year_moresamples/NDT/NDT_1982_2021.pkl"
