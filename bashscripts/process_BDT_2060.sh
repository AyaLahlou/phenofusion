...
#SBATCH --job-name=process_2060    # The job name
#SBATCH --output=process_6020.out    # The output file name
...
PFT="BDT_60_20"
DATA_DIR="/burg-archive/glab/users/al4385/data/CSIFMETEO/sorted_BDT_-20_-60_1982_2021.parquet"
